...
import { LayoutDashboard, Users, BookOpen, Briefcase, GraduationCap, Newspaper, X, ScrollText, ShieldCheck, LogIn, LogOut } from 'lucide-react';
        ...
        <div className="flex flex-col justify-center h-24 px-6 bg-[#000F2E] border-b border-slate-700 shrink-0">
          <div className="flex items-center justify-between">
             <div className="flex flex-col">
                <span className="text-2xl font-black italic text-white leading-none tracking-tighter flex items-center gap-1">
                  C<span className="text-[#F58220]">J</span>CC
                </span>
                <span className="text-[8px] text-slate-300 uppercase tracking-[0.2em] mt-2 font-black leading-tight max-w-[120px]">
                  Báo Chí với Văn Hoá Doanh Nghiệp
                </span>
             </div>
